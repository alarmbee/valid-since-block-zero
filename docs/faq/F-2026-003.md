...
links:
  ...
  branches:
    faq-kapcsolodo-sajat-cel:
      "GYIK: Validációra kötelezettek és esetek": "F-2026-001"
...
A VSBZ eddigi összefoglalója is kiemeli, hogy ez a kivétel **kifejezetten kripto→kripto irányt emel ki**. (<Branch popup="faq-kapcsolodo-sajat-cel">Kapcsolódó</Branch>)
